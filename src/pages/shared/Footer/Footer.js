...
const Footer = () => {
    return (
        <footer className="px-4 mt-12 divide-y bg-black dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link className='font-bold text-2xl cursor-pointer flex items-center text-gray-50'>
                        ...
                        Swap <span className='text-lg font-semibold text-teal-600'>IT</span>
                    </Link>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">© 2022 Swap IT. All rights reserved.</div>
        </footer>
    );
};
