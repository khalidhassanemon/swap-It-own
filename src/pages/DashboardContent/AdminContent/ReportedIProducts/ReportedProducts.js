...
const ReportedProducts = () => {
    ...
    const { data: reports = [], refetch, isLoading } = useQuery({
        queryKey: ['report'],
        queryFn: async () => {
            const res = await fetch('https://swap-it-server.vercel.app/reports');
    ...
    const handleDeleteProduct = products => {
        ...
        fetch(`https://swap-it-server.vercel.app/products/${products.productId}`, {
            method: 'DELETE',
            headers: {
        ...
        fetch(`https://swap-it-server.vercel.app/reported-products/${products._id}`, {
            method: 'DELETE',
            headers: {
